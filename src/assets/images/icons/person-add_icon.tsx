...
interface DefaultPersonAddIconProps {
  color?: string;
  width?: string;
  height?: string;
}

export const DefaultPersonAddIcon = ({
  color = 'var(--color-icon-primary)',
  width,
  height,
}: DefaultPersonAddIconProps) => (
<svg
  width={width}
  height={height}
  viewBox="0 0 24 24"
