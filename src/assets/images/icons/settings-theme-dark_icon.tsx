...
interface DefaultSettingsThemeDarkIconProps {
  color?: string;
  width?: string;
  height?: string;
}

export const DefaultSettingsThemeDarkIcon = ({
  color = 'var(--color-icon-primary)',
  width,
  height,
}: DefaultSettingsThemeDarkIconProps) => (
<svg
  width={width}
  height={height}
  viewBox="0 0 24 24"
