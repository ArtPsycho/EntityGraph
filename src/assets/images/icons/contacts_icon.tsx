...
interface DefaultContactsIconProps {
  color?: string;
  width?: string;
  height?: string;
}

export const DefaultContactsIcon = ({
  color = 'var(--color-icon-primary)',
  width,
  height,
}: DefaultContactsIconProps) => (
<svg
  width={width}
  height={height}
  viewBox="0 0 24 24"
